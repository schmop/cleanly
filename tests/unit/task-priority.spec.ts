...
vi.useFakeTimers().setSystemTime(NOW_IN_SECONDS * 1000);
...
describe('task-priority', () => {
    ...
    // `duration` is in hours (task-priority.ts: `duration * HOUR_IN_SECONDS`).
    // 24 hours = 1 day so DAY_IN_SECONDS expectations below line up.
